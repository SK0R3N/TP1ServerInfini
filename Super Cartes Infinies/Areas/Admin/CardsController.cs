...
namespace Super_Cartes_Infinies.Areas.Admin
{
    ...
    public class CardsController : Controller
    {
        ...
        // GET: Admin/Cards/StartedCard/5
        public async Task<IActionResult> StartedCard(int? id)
        {
            if (id == null || _context.Cards == null)
            {
                return NotFound();
            ...
            card.CarteDepart = !card.CarteDepart;
        ...
        [HttpPost]
        public async Task<IActionResult> Create([Bind("Id,Name,Attack,Defense,ImageUrl,CarteDepart")] Card card)
        {
        ...
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Attack,Defense,ImageUrl,CarteDepart")] Card card)
        {
            if (id != card.Id)
            {
                return NotFound();
